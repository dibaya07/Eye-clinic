      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-16 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-normal">
              Clear Vision Eye Hospital is committed to setting the premium
              benchmark in private eye care. Under senior surgeon Dr. Arjun
              Sharma, we combine fifteen years of micro-surgical mastery with
              world-class laser diagnostic technologies.
            </p>

            <p className="text-[10px] text-slate-500 font-medium leading-relaxed">
              *All medical and surgical techniques discussed here are planned
              individually after physical corneal checks.
            </p>
          </div>
            ...
            <ul className="space-y-2.5 text-xs font-semibold text-slate-400">
              <li>
                <a
                  ...
                  className="hover:text-medical-400 flex items-center gap-1 transition"
                >
          ...
          <div className="lg:col-span-2.5 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs font-semibold text-slate-400">
              ...
              <li>
                <a
                  href="#gallery"
                  onClick={(e) => handleFooterLinkClick(e, "#gallery")}
                  className="hover:text-medical-400 flex items-center gap-1 transition"
                >
                  <ChevronRight className="w-3.5 h-3.5 shrink-0" />
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-500 text-[11px] font-semibold">
          ...
          <div className="flex items-center gap-1.5 text-slate-400 bg-white/5 border border-white/5 rounded-full py-1 px-3.5 max-w-lg text-center md:text-left">
            ...
            <span>Disclaimer: General medical information only.</span>
          </div>

          <div className="flex gap-4">
            <a
              href="#appointment"
              onClick={(e) => handleFooterLinkClick(e, "#appointment")}
